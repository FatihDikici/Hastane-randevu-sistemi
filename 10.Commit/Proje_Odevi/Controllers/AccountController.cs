...
namespace Proje_Odevi.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public IActionResult ProfileChangeFullName([Required(ErrorMessage = "Ad soyad kısmı boş bırakılamaz!")] string fullname)
        {
        ...
        [HttpPost]
        public IActionResult ProfileChangePassword([Required][MinLength(6, ErrorMessage = "Şifrenizi tekrar giriniz,en az 6 haneli olmalıdır!")] string password)
        {
        ...
        [HttpPost]
        public IActionResult ProfileChangeImage([Required(ErrorMessage = "Lütfen dosya seçiniz!")] IFormFile file)
        {
